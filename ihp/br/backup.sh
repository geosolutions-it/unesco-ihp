...
# ##########################################################
# Run a backup
#  SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./ihp/br/backup.sh $BKP_FOLDER_NAME
#   - BKP_FOLDER_NAME:
...
#
# e.g.:
#  docker exec -it django4ihp sh -c 'SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./ihp/br/backup.sh $BKP_FOLDER_NAME'
# ##########################################################
...
./manage.sh backup -i -f -c $PWD/ihp/br/settings_docker.ini --backup-dir /$BKP_FOLDER_NAME/
